    ...
    return (
        <div className="flex h-screen overflow-hidden">
                        ...
                        <div className="">
                            <ul className="mb-6 flex flex-col gap-1.5">
                                <ul className="menu  text-white w-56 rounded-box">
                                    <li className="hover:bg-primary duration-200 ease-in-out rounded-md">
                                        <Link href=''>
            ...
            <div className="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
                <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-lg shadow-lg py-5 dark:bg-boxdark dark:drop-shadow-none">
